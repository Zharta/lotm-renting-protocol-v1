...
function removeExpiredWalletLinks(
  ...
  internal
  {
    ...
    removeExpiredWalletLinks(hotWalletAddress);
  }
  ...
  )
  {
    ...
    if (hotWalletLink.walletAddress != address(0) &&
        hotWalletLink.expirationTimestamp >= block.timestamp) {
