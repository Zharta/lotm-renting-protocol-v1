...
def cli(network):
    ...
    changes = set()
    changes |= {"common.vault_impl_koda_ape_v3", "common.renting_erc721_koda_v3", "renting.koda_v3"}
    changes |= {"common.vault_impl_mara_ape_v3", "common.renting_erc721_mara_v3", "renting.mara_v3"}
